    ...
    public function dataProcess(): array
    {
        ...
        $dataSets[] = [
            ...
            [
                ...
                '012 Create PHPDoc with typed array type hint for C3 constant, .e.g.: "string[]" or "SomeClass[]"',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '040 Replace array type with typed array type in PHPDoc for parameter $j. Use mixed[] for generic arrays. Correct array depth must be specified.',
