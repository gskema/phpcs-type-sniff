...
class CompositeCodeElementSniffTest extends TestCase
{
    ...
    public function dataProcess(): array
    {
        ...
        $dataSets[] = [
            ...
            [
                '010 Replace array type with typed array type in PHPDoc for C2 constant. Use mixed[] for generic arrays. Correct array depth must be specified.',
                ...
                '028 Replace array type with typed array type in PHPDoc for property $prop4. Use mixed[] for generic arrays. Correct array depth must be specified.',
                '031 Replace array type with typed array type in PHPDoc for property $prop5. Use mixed[] for generic arrays. Correct array depth must be specified.',
                '034 Add PHPDoc with typed array type hint for property $prop6. Use mixed[] for generic arrays. Correct array depth must be specified.',
                '040 Remove property name $prop8 from @var tag',
                '046 Replace array type with typed array type in PHPDoc for property $prop10. Use mixed[] for generic arrays. Correct array depth must be specified.',
                '052 Replace array type with typed array type in PHPDoc for C6 constant. Use mixed[] for generic arrays. Correct array depth must be specified.',
