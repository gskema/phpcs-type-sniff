    ...
    public function dataProcess(): array
    {
        ...
        $dataSets[] = [
            ...
            [
                ...
                '073 Replace nullable type "?int" with compound type with null "int|null" for property $prop4.',
                '074 Add type declaration for property $prop4, e.g.: "?int". Add default value or keep property in an uninitialized state.',
                '076 Replace nullable type "?int|string" with compound type with null "int|string|null" for property $prop5.',
                '080 Replace nullable type "?string" with compound type with null "string|null" for parameter $a.',
                '080 Type hint "?string" is not compatible with parameter $a value type',
                '080 Missing "null, string" types in parameter $a type hint',
                '081 Replace nullable type "?int" with compound type with null "int|null" for return value.',
