    ...
    public function dataProcess(): array
    {
        ...
        $dataSets[] = [
            ...
            [
                ...
                '031 Add type declaration for property $prop5, e.g.: "array|string". Add default value or keep property in an uninitialized state.',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '031 Change type hint for parameter $h to null or union, e.g. SomeClass|null',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '042 Type hints "string, float" are not compatible with return value type',
                '042 Missing "null, int" types in return value type hint',
                '065 Type hint "string" is not compatible with return value type',
                '072 Type hint "string" is not compatible with return value type',
            ],
        ];
        ...
        $dataSets[] = [
            ...
            [
                ...
                '037 Type hint "static" is not compatible with return value type',
                '037 Missing "self" type in return value type hint',
                '094 Doc type "$this" for return value does not provide additional code intel and can be replaced with declared type "self".',
                ...
                '126 Type hint "mixed" is not compatible with return value type',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '048 Add type declaration for parameter $arg7, e.g.: "float".',
                ...
                '070 Change type hint for parameter $arg1 to null or union, e.g. SomeClass|null',
                ...
                '092 Use null return value type declaration or change type to union, e.g. SomeClass|null',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '048 Add type declaration for parameter $arg9, e.g.: "Location|Node|NodeList|array|string".',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '048 Add type declaration for parameter $arg7, e.g.: "float". [5b08af5e35028a51]',
                ...
                '070 Change type hint for parameter $arg1 to null or union, e.g. SomeClass|null [a5f61721f93bca70]',
                ...
                '092 Use null return value type declaration or change type to union, e.g. SomeClass|null [68a9b7cd51440244]',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '077 Add type declaration for property $prop5, e.g.: "int|null|string". Add default value or keep property in an uninitialized state.',
                ...
                '081 Type hint "?int" is not compatible with return value type',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '022 Add type declaration for property $prop6, e.g.: "int|null|string". Add default value or keep property in an uninitialized state.',
        ...
        $dataSets[] = [
            ...
            [
                ...
                '023 Doc type "$this" for return value does not provide additional code intel and can be replaced with declared type "self".',
                '023 Missing "self" type in return value type hint',
                '030 Doc type "$this" for return value does not provide additional code intel and can be replaced with declared type "static".',
                '030 Missing "static" type in return value type hint',
                '039 Add type declaration for return value, e.g.: "self".',
                '046 Useless PHPDoc',
                '051 Type hint "self" is not compatible with return value type',
